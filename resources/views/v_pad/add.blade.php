...
@section('title', 'Tambah PAD Trayek')
@section('content')

<form action="/v_pad/insert" method="post" enctype="multipart/form-data">
    @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kod_rek" class="form-control" id="kod_rek" value="{{old('kod_rek')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_bukti" class="form-control" id="no_bukti" value="{{old('no_bukti')}}">
                                    <div class="text-danger">
                                        @error('no_bukti')
                                        {{$message}}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="grup" class="form-control" id="grup" value="{{old('grup')}}">
                                    <div class="text-danger">
                                        @error('grup')
                                        {{$message}}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="retribusi" class="form-control" id="retribusi" value="{{old('retribusi')}}">
                                    <div class="text-danger">
                                        @error('retribusi')
                                        {{$message}}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jumlah" class="form-control" id="jumlah" value="{{old('jumlah')}}">
                                    <div class="text-danger">
                                        @error('jumlah')
                                        {{$message}}
                                        @enderror
