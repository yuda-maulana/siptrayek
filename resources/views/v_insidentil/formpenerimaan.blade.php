...
@section('title', 'Form Penerimaan Biaya Izin Insidentil')
@section('content')
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="modal-footer">
                    <a href="" onclick="this.href='/v_insidentil/cetakpenerimaan/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value" target="_blank"><button class="btn btn-success">Cetak Laporan</button></a>
