        ...
        <div class="col-xs-15">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="/v_insidentil/insidentil">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>{{Carbon\Carbon::parse($data->habis_uji)->isoFormat('D MMMM Y')}} </td>
                            <td>
                                <a href="/v_insidentil/detail/{{$data->id}}" class="btn btn-sm btn-info">Detail</a>
                                <a href="/v_insidentil/edit/{{$data->id}}" class="btn btn-sm btn-warning">Edit</a>
                ...
                <div class="box-footer clearfix">
                    <div class="d-flex justify-content-center">
                        <p>Halaman saat ini : <b>{{$insidentil->currentPage() }}</b></p>
                        <p>Jumlah Data : <b>{{$insidentil->total() }}</b></p>
                        <p>Data perhalaman : <b>{{$insidentil->perPage() }}</b></p>
                        {{$insidentil->links()}}
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/v_insidentil/delete/{{$data->id}}" class="btn btn-outline">Ya</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
