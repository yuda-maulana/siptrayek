        ...
        <div class="col-xs-15">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <br>
                        <form action="/v_trayek/trayek" method="get">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            @if (!(strtotime($data->tgl_sk) <= time() AND time()>= strtotime($data->akhir_sk)))
                                ...
                                <td>
                                    <a href="/v_trayek/detail/{{$data->id}}" class="btn btn-sm btn-info">Detail</a>
                                    <a href="/v_trayek/edit/{{$data->id}}" class="btn btn-sm btn-warning">Edit</a>
                ...
                <div class="box-footer clearfix">
                    <div class="d-flex justify-content-center">
                        <p>Halaman saat ini : <b>{{$trayek->currentPage() }}</b></p>
                        <p>Jumlah Data : <b>{{$trayek->total() }}</b></p>
                        <p>Data perhalaman : <b>{{$trayek->perPage() }}</b></p>
                        {{$trayek->links()}}
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/v_trayek/delete/{{$data->id}}" class="btn btn-outline">Ya</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
