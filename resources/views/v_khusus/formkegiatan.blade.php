...
@section('title', 'Form Laporan Kegiatan Izin Khusus')
@section('content')
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="modal-footer">
                    <a href="" onclick="this.href='/v_khusus/cetaklaporan/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value" target="_blank"><button class="btn btn-success">Cetak Laporan</button></a>
