...
<form action="/v_usaha/updateklasifikasi/{{$klsusaha->id}}" method="post" enctype="multipart/form-data">
    @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_uji" class="form-control" id="no_uji" value="{{$klsusaha->no_uji}}">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="terbit" class="form-control" id="terbit" value="{{$klsusaha->terbit}}">
                                    <div class="text-danger">
                                        @error('terbit')
                                        {{$message}}
                                        @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_kend" class="form-control" id="no_kend" value="{{$klsusaha->no_kend}}">
                                    <div class="text-danger">
                                        @error('no_kend')
                                        {{$message}}
                                        @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pemilik" class="form-control" id="pemilik" value="{{$klsusaha->pemilik}}">
                                    <div class="text-danger">
                                        @error('pemilik')
                                        {{$message}}
                                        @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jbb" class="form-control" id="jbb" value="{{$klsusaha->jbb}}">
                                    <p>Kg</p>
                                    <div class="text-danger">
                                        @error('jbb')
                                        {{$message}}
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="orang" class="form-control" id="orang" value="{{$klsusaha->orang}}">
                                    <p>Orang</p>
                                    <div class="text-danger">
                                        @error('orang')
                                        {{$message}}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="x_katagori" id="x_katagori">
                                        <option value="{{$klsusaha->x_katagori}}">{{$klsusaha->x_katagori}}</option>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="x_kelas" id="x_kelas">
                                        <option value="{{$klsusaha->x_kelas}}">{{$klsusaha->x_kelas}}</option>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="n_ret" class="form-control" id="n_ret" value="{{$klsusaha->n_ret}}">
                                    <div class="text-danger">
                                        @error('n_ret')
                                        {{$message}}
                                        @enderror
