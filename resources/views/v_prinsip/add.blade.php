...
@section('title', 'Tambah Izin Prinsip')
@section('content')
<form action="/v_prinsip/insert" method="post" enctype="multipart/form-data">
    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_rekom" class="form-control" id="no_rekom" value="{{old('no_rekom')}}">
                                    <div class="text-danger">
                                        @error('no_rekom')
                                        {{$message}}
                                        @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_rekom" class="form-control" id="tgl_rekom" value="{{old('tgl_rekom')}}">
                                    <div class="text-danger">
                                        @error('tgl_rekom')
                                        {{$message}}
                                        @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mohon" class="form-control" id="mohon" value="{{old('mohon')}}">
                                    <div class="text-danger">
                                        @error('mohon')
                                        {{$message}}
                                        @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_mohon" class="form-control" id="no_mohon" value="{{old('no_mohon')}}">
                                    <div class="text-danger">
                                        @error('no_mohon')
                                        {{$message}}
                                        @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_mohon" class="form-control" id="tgl_mohon" value="{{old('tgl_mohon')}}">
                                    <div class="text-danger">
                                        @error('tgl_mohon')
                                        {{$message}}
                                        @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="orang" class="form-control" value="{{old('orang')}}" id="orang">
                                    <div class="text-danger">
                                        @error('orang')
                                        {{$message}}
                                        @enderror
